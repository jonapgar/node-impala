    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i497 = 0; _i497 < _size492; ++_i497)
        {
          ...
          this.partitionnames.push(elem498);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
AddDynamicPartitions.prototype.write = function(output) {
  ...
  if (this.partitionnames !== null && this.partitionnames !== undefined) {
    ...
    for (var iter499 in this.partitionnames)
    {
      if (this.partitionnames.hasOwnProperty(iter499))
      {
        iter499 = this.partitionnames[iter499];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem506 = null;
          elem506 = new ttypes.NotificationEvent();
          elem506.read(input);
          this.events.push(elem506);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
NotificationEventResponse.prototype.write = function(output) {
  ...
  if (this.events !== null && this.events !== undefined) {
    ...
    for (var iter507 in this.events)
    {
      if (this.events.hasOwnProperty(iter507))
      {
        iter507 = this.events[iter507];
...
InsertEventRequestData.prototype.write = function(output) {
  ...
  if (this.filesAdded !== null && this.filesAdded !== undefined) {
    ...
    for (var iter515 in this.filesAdded)
    {
      if (this.filesAdded.hasOwnProperty(iter515))
      {
        iter515 = this.filesAdded[iter515];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i521 = 0; _i521 < _size516; ++_i521)
        {
          ...
          this.partitionVals.push(elem522);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
FireEventRequest.prototype.write = function(output) {
  ...
  if (this.partitionVals !== null && this.partitionVals !== undefined) {
    ...
    for (var iter523 in this.partitionVals)
    {
      if (this.partitionVals.hasOwnProperty(iter523))
      {
        iter523 = this.partitionVals[iter523];
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i529 = 0; _i529 < _size524; ++_i529)
        {
          var key530 = null;
          var val531 = null;
          key530 = input.readI64();
          val531 = new ttypes.MetadataPpdResult();
          val531.read(input);
...
GetFileMetadataByExprResult.prototype.write = function(output) {
  ...
  if (this.metadata !== null && this.metadata !== undefined) {
    ...
    for (var kiter532 in this.metadata)
    {
      if (this.metadata.hasOwnProperty(kiter532))
      {
        var viter533 = this.metadata[kiter532];
        output.writeI64(kiter532);
        viter533.write(output);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem540 = null;
          elem540 = input.readI64();
          this.fileIds.push(elem540);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
GetFileMetadataByExprRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    ...
    for (var iter541 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter541))
      {
        iter541 = this.fileIds[iter541];
        output.writeI64(iter541);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i547 = 0; _i547 < _size542; ++_i547)
        {
          var key548 = null;
          var val549 = null;
          key548 = input.readI64();
          val549 = input.readBinary();
...
GetFileMetadataResult.prototype.write = function(output) {
  ...
  if (this.metadata !== null && this.metadata !== undefined) {
    ...
    for (var kiter550 in this.metadata)
    {
      if (this.metadata.hasOwnProperty(kiter550))
      {
        var viter551 = this.metadata[kiter550];
        output.writeI64(kiter550);
        output.writeBinary(viter551);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem558 = null;
          elem558 = input.readI64();
          this.fileIds.push(elem558);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
GetFileMetadataRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    output.writeFieldBegin('fileIds', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.I64, this.fileIds.length);
    for (var iter559 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter559))
      {
        iter559 = this.fileIds[iter559];
        output.writeI64(iter559);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem566 = null;
          elem566 = input.readI64();
          this.fileIds.push(elem566);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem573 = null;
          elem573 = input.readBinary();
          this.metadata.push(elem573);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
PutFileMetadataRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    output.writeFieldBegin('fileIds', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.I64, this.fileIds.length);
    for (var iter574 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter574))
      {
        iter574 = this.fileIds[iter574];
        output.writeI64(iter574);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  if (this.metadata !== null && this.metadata !== undefined) {
    ...
    for (var iter575 in this.metadata)
    {
      if (this.metadata.hasOwnProperty(iter575))
      {
        iter575 = this.metadata[iter575];
        output.writeBinary(iter575);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem582 = null;
          elem582 = input.readI64();
          this.fileIds.push(elem582);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ClearFileMetadataRequest.prototype.write = function(output) {
  ...
  if (this.fileIds !== null && this.fileIds !== undefined) {
    output.writeFieldBegin('fileIds', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.I64, this.fileIds.length);
    for (var iter583 in this.fileIds)
    {
      if (this.fileIds.hasOwnProperty(iter583))
      {
        iter583 = this.fileIds[iter583];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem590 = null;
          elem590 = new ttypes.Function();
          elem590.read(input);
          this.functions.push(elem590);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
GetAllFunctionsResponse.prototype.write = function(output) {
  ...
  if (this.functions !== null && this.functions !== undefined) {
    ...
    for (var iter591 in this.functions)
    {
      if (this.functions.hasOwnProperty(iter591))
      {
        iter591 = this.functions[iter591];
